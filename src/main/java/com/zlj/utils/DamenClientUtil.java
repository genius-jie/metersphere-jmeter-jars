...
public class DamenClientUtil {
    public static DamenServer build(String jdbcString, String urlString, String userName, String passWord) {
        try {
            return new DamenServer(jdbcString, urlString, userName, passWord);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
    ...
    public static class DamenServer {
        private Connection connection = null;

        DamenServer(String jdbcString, String urlString, String userName, String passWord) throws Exception {
